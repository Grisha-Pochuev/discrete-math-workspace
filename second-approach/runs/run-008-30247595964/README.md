# Second-approach run 008

- GitHub Actions run: `30247595964`
- workflow conclusion: `success`
- accepted as a completed research run: `True`
- jobs present: 20/20
- optimized attempts: 354820
- skipped controls with known sparse obstruction: 0
- numerical solutions below 1e-8: 0
- best maximum equation error: 1.1781092801423294e-05
- preserved full-weight candidates: 400
