#!/usr/bin/env python3
"""Synthetic contract tests for the sharded exact-cut workflow."""
...
SPEC = SIXTH / "specs" / "run-061-adaptive-exact-cuts.json"
...
class Run061ContractTest(unittest.TestCase):
    def test_complete_matrix_archive_and_unknown_rejection(self):
        ...
        with tempfile.TemporaryDirectory(dir=SIXTH) as temporary:
            ...
            self.assertEqual(report["validated_shards"], 48)
