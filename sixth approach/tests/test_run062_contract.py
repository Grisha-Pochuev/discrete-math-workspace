#!/usr/bin/env python3
"""Synthetic contract tests for grouped version-2 exact-cut shards."""
...
SPEC = SIXTH / "specs" / "run-062-adaptive-exact-cuts.json"
BUNDLE = SIXTH / "specs" / "run-062-exact-event-cuts.json"
HEADER = SIXTH / "run052_adaptive" / "exact_event_cuts_v2.h"
...
class Run062ContractTest(unittest.TestCase):
